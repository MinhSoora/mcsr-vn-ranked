                        ...
                        <div className="flex items-center gap-4">
                          ...
                          {stats.bestTime && (
                            <div className="text-right bg-black/50 px-4 py-3 rounded-lg border-2 border-yellow-600">
                              <p className="text-sm text-gray-400 font-bold">KỶ LỤC</p>
                              <p className="text-3xl font-black text-yellow-400" style={{textShadow: '2px 2px 0 #000'}}>
                          ...
                          <div className="mt-5 pt-5 border-t-4 border-green-700/50">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                              <div className="bg-black/60 rounded-lg p-4 border-2 border-green-600">
                                <p className="text-sm text-gray-400 mb-1 font-bold">TỔNG TRẬN</p>
                                <p className="text-2xl font-black text-white">{stats.total}</p>
                              </div>
                              <div className="bg-black/60 rounded-lg p-4 border-2 border-yellow-600">
                                <p className="text-sm text-gray-400 mb-1 font-bold">ELO CAO NHẤT</p>
                                <p className="text-2xl font-black text-yellow-400">{stats.highestElo}</p>
                              </div>
                              <div className="bg-black/60 rounded-lg p-4 border-2 border-blue-600">
                                <p className="text-sm text-gray-400 mb-1 font-bold">TỶ LỆ THẮNG</p>
                              ...
                              <div className="bg-black/60 rounded-lg p-4 border-2 border-red-600">
                                <p className="text-sm text-gray-400 mb-1 font-bold">TỶ LỆ THUA</p>
                                <p className="text-2xl font-black text-red-400">{stats.loseRate}%</p>
                              </div>
                              <div className="bg-black/60 rounded-lg p-4 border-2 border-purple-600">
                                <p className="text-sm text-gray-400 mb-1 font-bold">THỜI GIAN TỐT NHẤT</p>
                                <p className="text-xl font-black text-purple-400">
                                  {stats.bestTime ? formatTime(stats.bestTime) : 'N/A'}
                                </p>
                              </div>
                              <div className="bg-black/60 rounded-lg p-4 border-2 border-orange-600">
                                <p className="text-sm text-gray-400 mb-1 font-bold">THỜI GIAN TB</p>
                                <p className="text-xl font-black text-orange-400">
                                  {stats.avgTime ? formatTime(stats.avgTime) : 'N/A'}
                                </p>
                              </div>
                              <div className="bg-black/60 rounded-lg p-4 border-2 border-green-600">
                                <p className="text-sm text-gray-400 mb-1 font-bold">CHIẾN THẮNG</p>
                                <p className="text-2xl font-black text-green-400">{stats.wins}</p>
                              </div>
                              <div className="bg-black/60 rounded-lg p-4 border-2 border-red-600">
                                <p className="text-sm text-gray-400 mb-1 font-bold">THẤT BẠI</p>
                                <p className="text-2xl font-black text-red-400">{stats.loses}</p>
                              </div>
                            </div>
                          </div>
                        )}
